...
class SeperationActivityRowItem extends StatelessWidget {

    final Map<String, dynamic> customer;
    SeperationActivityRowItem({this.customer});
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                Text(customer["Surname"] + " " + customer["OtherNames"],
                  style: TextStyle(
                    fontSize: 10.0,
                ...
                Column(  
                  ...
                  children: <Widget>[                          
                   ...
                   // "#"+numberFormat.format(history.amountPaid)
                    Text(
                      customer["DateCaptured"] == null ? "NA" : customer["DateCaptured"],
                      style: TextStyle(
                        fontSize: 10.0,
                        fontWeight: FontWeight.bold,
                        color: Colors.red
