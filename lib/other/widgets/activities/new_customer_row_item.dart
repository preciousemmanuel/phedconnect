...
class NewCustomerActivityRowItem extends StatelessWidget {

    final Map<String, dynamic> customer;
    NewCustomerActivityRowItem({this.customer});
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                ...
                Text(customer["Surname"].trim() + " " + customer["OtherNames"],
                  style: TextStyle(
                    fontSize: 10.0,
              ...
              children: <Widget>[
                 Row(
                  children: <Widget>[
                    ...
                    SizedBox(width: 3,),
                    Text(customer["DateCaptured"] == null ? "NA" : customer["DateCaptured"],
                      style: TextStyle(
                        fontSize: 12.0,
                        fontWeight: FontWeight.bold,
                        color: Colors.grey
