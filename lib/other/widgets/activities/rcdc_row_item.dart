...
class RCDCActivitiesRowItem extends StatelessWidget {

    final Customer customer;
    RCDCActivitiesRowItem({this.customer});
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Text(customer.phoneNo == null ? "NA" : customer.phoneNo,
                  style: TextStyle(
                    fontSize: 12.0,
                    fontWeight: FontWeight.w400,
                    color: Colors.grey
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Text(customer.email == null ? "NA" : customer.email,
                  style: TextStyle(
                    fontSize: 12.0,
                    fontWeight: FontWeight.w400,
                    color: Colors.grey
            ...
            Row(
              ...
              children: <Widget>[
                Column(  
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,                       
                  children: <Widget>[                          
                    Text("Date of Disconnection: ${customer.lastPayDate}",
                      style: TextStyle(
                        fontSize: 10.0,
                        fontWeight: FontWeight.bold,
                        color: Colors.red
