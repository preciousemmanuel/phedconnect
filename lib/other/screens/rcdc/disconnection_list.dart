...
import '../../screens/rcdc/disconnection_details.dart';
import '../../utilities/alert_dialog.dart';
import '../../widgets/dclist/customer_row_item.dart';

class DisconnectionListScreen extends StatefulWidget {
    
  @override
  _DisconnectionListScreenState createState() => _DisconnectionListScreenState();
}


class _DisconnectionListScreenState extends State<DisconnectionListScreen> {
    ...
    fetchCustomerDCList() async{
        ...
        Map<String, dynamic> res  = await model.fetchCustomerDisconnectionList();
              ...
              appBar: AppBar(
                ...
                actions: <Widget>[
                  Padding(
                    ...
                    child: Text("Customers Found(${_currentList.length})", textAlign: TextAlign.center,),
                  )
                ],
