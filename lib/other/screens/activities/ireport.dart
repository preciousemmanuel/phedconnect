import '../../controllers/activities/ireport_activities._controller.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import '../../utilities/alert_dialog.dart';
import '../../widgets/activities/ireport_row_item.dart';


class IreportActivitiesScreen extends StatefulWidget {
    
  @override
    _IreportActivitiesScreenState createState() => _IreportActivitiesScreenState();
}

class _IreportActivitiesScreenState extends State<IreportActivitiesScreen> {

    final IreportActivityController model = IreportActivityController();
    ...
    _filterCustomer(){
       ...
       // showAlertDialog(context: context, isLoading: true, loadingMsg: "Fetching customer");
        ...
        return item["ReportCategory"].toLowerCase().contains(sortingAccountMeterNo.toLowerCase()) || 
          item["ReportSubCategory"].toLowerCase().contains(sortingAccountMeterNo.toLowerCase());
        }).toList();
    ...
    void showComments(BuildContext context, String comments){
      showModalBottomSheet(context: context, 
        ...
        children: <Widget>[
          Text("COMMENTS", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.white),),
          SizedBox(height: 6.0,),
    ...
    fetchCustomerDCList() async{
        ...
        Map<String, dynamic> res  = await model.myActivityIreport();
    ...
    */
    ...
    return RefreshIndicator(
          ...
          onRefresh: (){
            ...
            return Navigator.pushNamed(context, "/activity_ireport");
          },
          child: Container(
             decoration: BoxDecoration(
              image: DecorationImage(
                ...
                Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index){
                        ...
                        return InkWell(
                          onTap: (){showComments(context, customer["Comments"]);},
                       /* onTap: () => Navigator.push(
                        ...
                        child: Container(                    
                            ...
                            child: IreportActivityRowItem(customer: customer)
                            )
                          );
                      }
                    ),
    ...
    Widget build(BuildContext context) {
        return new WillPopScope(
            ...
            appBar: AppBar(
              ...
              title: Text("My i-Report Activities(${_dcCustomerList.length.toString()})", style: TextStyle(fontSize: 14),),
            ),
