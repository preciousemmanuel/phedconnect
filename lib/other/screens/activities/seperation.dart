import '../../controllers/activities/seperation_activities_controller.dart';
import '../../widgets/activities/seperation_row_item.dart';
...
class SeperationActivitiesScreen extends StatefulWidget {
    
  @override
  _SeperationActivitiesScreenState createState() => _SeperationActivitiesScreenState();
}


class _SeperationActivitiesScreenState extends State<SeperationActivitiesScreen> {

    final SeperationActivityController model = SeperationActivityController();
    ...
    fetchCustomerDCList() async{
        ...
        Map<String, dynamic> res  = await model.myActivitySeperation();
                      ...
                      itemBuilder: (BuildContext context, int index){
                       ...
                       /* onTap: () => Navigator.push(
                        ...
                        child: Container(                    
                            ...
                            child: SeperationActivityRowItem(customer: customer)
                            )
                          );
                      }
                    ),
      ...
      Widget build(BuildContext context) {
          return new WillPopScope(
              ...
              appBar: AppBar(
                ...
                title: Text("My Account Seperation Activities(${_dcCustomerList.length.toString()})", style: TextStyle(fontSize: 14),),
              ),
