...
import '../../controllers/activities/tariff_change_controller.dart';
import '../../utilities/alert_dialog.dart';
import '../../widgets/activities/tariff_change_row_item.dart';


class TariffChangeActivitiesScreen extends StatefulWidget {
    
  @override
  _TariffChangeActivitiesScreenState createState() => _TariffChangeActivitiesScreenState();
}


class _TariffChangeActivitiesScreenState extends State<TariffChangeActivitiesScreen> {

    final TariffChangeController model = TariffChangeController();
    ...
    fetchCustomerDCList() async{
        ...
        Map<String, dynamic> res  = await model.myActivityTariffChange();
                      ...
                      itemBuilder: (BuildContext context, int index){
                       ...
                       /* onTap: () => Navigator.push(
                        ...
                        child: Container(                    
                            ...
                            child: TariffChangeActivityRowItem(customer: customer)
                            )
                          );
                      }
                    ),
      ...
      Widget build(BuildContext context) {
          return new WillPopScope(
              ...
              appBar: AppBar(
                ...
                title: Text("My Tariff Change Activities(${_dcCustomerList.length.toString()})", style: TextStyle(fontSize: 14),),
              ),
