...
class RPDFindCustomer extends StatefulWidget {
  @override
  _RPDFindCustomerState createState() => _RPDFindCustomerState();
}

class _RPDFindCustomerState extends State<RPDFindCustomer> {
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index){
                ...
                onTap: () => Navigator.push(
                  context, 
                  MaterialPageRoute(builder: (context)=> DisconnectionDetailsScreen(customer, flag: "rpd"))
                ),
                child: Container(                    
